...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0f0c29,50:302b63,100:24243e&height=200&section=header&text=GigShield%20AI&fontSize=60&fontColor=00F7FF&animation=fadeIn"/>
...
git clone https://github.com/your-team/gigshield-ai.git
cd gigshield-ai

# 2. Start infrastructure (Kafka, PostgreSQL, Redis, MongoDB)
...
# RAZORPAY_KEY_ID= (sandbox)
# RAZORPAY_KEY_SECRET= (sandbox)
# TWILIO_ACCOUNT_SID=
# TWILIO_AUTH_TOKEN=
...
## 🧪 Simulating a Disruption (Demo Mode)

```bash
# Trigger a simulated heavy rain event in Bengaluru — Indiranagar zone
curl -X POST http://localhost:3000/api/v1/disruptions/simulate \
  -H "Content-Type: application/json" \
  -d '{
    "type": "HEAVY_RAIN",
    "zone": "BENGALURU_INDIRANAGAR",
    "intensity": "EXTREME",
    "rainfall_mm": 148,
    "duration_hours": 6
  }'
...
# Expected flow:
# ✓ Disruption Sentinel detects threshold breach
# ✓ Fraud Investigator runs on all active policies in zone
# ✓ Claims auto-approved for eligible workers
# ✓ Payout Orchestrator dispatches UPI via Razorpay sandbox
# ✓ WhatsApp notifications fired
...
| Feature | GigShield AI | IRDAI PMSBY | ESIC / Govt | Toffee/Bite-size |
|---------|:---:|:---:|:---:|:---:|
| Income Loss Coverage | ✅ Parametric, auto | ❌ Accident death only | ⚠️ Partial, salaried | ❌ Health/Device only |
| Payout Speed | ✅ **< 15 minutes** | ❌ 30–90 days | ❌ Weeks | ⚠️ 3–7 days |
| Zero Paperwork | ✅ Fully automated | ❌ Forms needed | ❌ Employer enrol needed | ⚠️ Some manual steps |
| Weekly Pricing | ✅ Weekly model | ❌ Annual only | ❌ Monthly only | ❌ No income coverage |
| Gig Worker Specific | ✅ Built for gig | ❌ Generic | ❌ Formal sector | ❌ Generic |
| AI Risk Profiling | ✅ Dynamic ML | ❌ Static rules | ❌ None | ⚠️ Basic rules |
| Platform API Integration | ✅ Swiggy/Zomato | ❌ None | ❌ None | ❌ None |
| Fraud Detection | ✅ GNN + GPS | ❌ None | ❌ None | ⚠️ Basic |
| Multilingual (8 langs) | ✅ | ❌ | ❌ | ⚠️ EN + HI only |
...
GigShield AI is designed from the ground up for IRDAI regulatory compliance:

- **IRDAI Sandbox License Path** — Targeting IRDAI Innovation Sandbox for pilot licensing
- **Data Privacy** — Compliant with DPDP Act 2023; all worker data encrypted at rest (AES-256) and in transit (TLS 1.3)
- **KYC / AML** — DigiLocker-based eKYC; Aadhaar-linked worker identity verification
- **Audit Trail** — Immutable, tamper-proof log of every claim decision and payout; exportable for regulatory review
- **Reinsurance Ready** — Risk tranching structure designed for Munich Re / Swiss Re partnership
...
[![Phase 1 Submission](https://img.shields.io/badge/📋%20Phase%201-Submitted%20March%2020-success?style=for-the-badge)](https://github.com)
[![Demo Video](https://img.shields.io/badge/🎬%20Demo%20Video-Watch%20Now-red?style=for-the-badge)](https://github.com)
[![Live Dashboard](https://img.shields.io/badge/📊%20Dashboard-View%20Demo-blue?style=for-the-badge)](https://github.com)
