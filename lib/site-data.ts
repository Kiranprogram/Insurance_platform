...
import rajuAvatar from '@/src/assets/images/avatars/raju.png'
import priyaAvatar from '@/src/assets/images/avatars/priya.png'
import vikramAvatar from '@/src/assets/images/avatars/vikram.png'
import amitAvatar from '@/src/assets/images/avatars/amit.png'
import sunitaAvatar from '@/src/assets/images/avatars/sunita.png'
import mohammedAvatar from '@/src/assets/images/avatars/mohammed.png'
import deepaAvatar from '@/src/assets/images/avatars/deepa.png'
import karanAvatar from '@/src/assets/images/avatars/karan.png'
import lakshmiAvatar from '@/src/assets/images/avatars/lakshmi.png'
import rahulAvatar from '@/src/assets/images/avatars/rahul.png'

export const HERO_TICKER_ITEMS = [
  { name: 'Raju K.', city: 'Bengaluru', amount: '₹892', avatar: rajuAvatar.src },
  { name: 'Priya S.', city: 'Mumbai', amount: '₹1,200', avatar: priyaAvatar.src },
  { name: 'Vikram T.', city: 'Delhi', amount: '₹456', avatar: vikramAvatar.src },
  { name: 'Amit R.', city: 'Chennai', amount: '₹780', avatar: amitAvatar.src },
  { name: 'Sunita D.', city: 'Pune', amount: '₹1,100', avatar: sunitaAvatar.src },
  { name: 'Mohammed A.', city: 'Hyderabad', amount: '₹634', avatar: mohammedAvatar.src },
  { name: 'Deepa N.', city: 'Kolkata', amount: '₹920', avatar: deepaAvatar.src },
  { name: 'Karan M.', city: 'Ahmedabad', amount: '₹540', avatar: karanAvatar.src },
  { name: 'Lakshmi V.', city: 'Bengaluru', amount: '₹1,050', avatar: lakshmiAvatar.src },
  { name: 'Rahul S.', city: 'Mumbai', amount: '₹875', avatar: rahulAvatar.src },
]
...
export const TOAST_WORKERS = [
  ...
  { name: 'Lakshmi V.', city: 'Bengaluru', amount: '₹1,050', avatar: lakshmiAvatar.src },
  { name: 'Rahul S.', city: 'Mumbai', amount: '₹875', avatar: rahulAvatar.src },
  { name: 'Anita G.', city: 'Chennai', amount: '₹990', avatar: amitAvatar.src },
  { name: 'Sanjay P.', city: 'Delhi', amount: '₹670', avatar: vikramAvatar.src },
  { name: 'Meera K.', city: 'Hyderabad', amount: '₹1,340', avatar: mohammedAvatar.src },
  { name: 'Suresh B.', city: 'Pune', amount: '₹560', avatar: sunitaAvatar.src },
  { name: 'Divya M.', city: 'Bengaluru', amount: '₹892', avatar: lakshmiAvatar.src },
]
